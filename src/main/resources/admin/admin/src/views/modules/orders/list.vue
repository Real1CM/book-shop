      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row  :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '商城图书名称' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.goodname" placeholder="商城图书名称" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.goodname" placeholder="商城图书名称" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.goodname" placeholder="商城图书名称" clearable></el-input>
                </el-form-item>
          <el-form-item>
	    ...
	    <download-excel v-if="isAuth('orders'+'/'+orderStatus,'导出')" class = "export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "订单.xls">
            ...
            >{{ contents.btnAdAllFont == 1?'商城图书销量':'' }}</el-button>
            <el-button
              v-if="isAuth('orders'+'/'+orderStatus,'品销量') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2"
              type="warning"
              @click="goodnameNumberChartDialog()"
            >{{ contents.btnAdAllFont == 1?'商城图书销量':'' }}<i class="el-icon-s-data el-icon--right" /></el-button>
            <el-button
            ...
            >{{ contents.btnAdAllFont == 1?'商城图书销额':'' }}</el-button>
            <el-button
              v-if="isAuth('orders'+'/'+orderStatus,'品销额') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2"
              type="warning"
              @click="goodnameAmountChartDialog()"
            >{{ contents.btnAdAllFont == 1?'商城图书销额':'' }}<i class="el-icon-s-data el-icon--right" /></el-button>
            <el-button
...
//导出excel
      json_fields: {
      "订单编号": "orderid",    //常规字段
      "商城图书表名": "tablename",    //常规字段
      "用户id": "userid",    //常规字段
      "商城图书id": "goodid",    //常规字段
      "商城图书名称": "goodname",    //常规字段
      "商城图书图片": "picture",    //常规字段
      "租赁数量": "buynumber",    //常规字段
      "价格": "price",    //常规字段
