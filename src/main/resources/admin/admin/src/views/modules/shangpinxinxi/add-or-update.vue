<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商城图书名称" prop="shangpinmingcheng">
          <el-input v-model="ruleForm.shangpinmingcheng"
              placeholder="商城图书名称" clearable  :readonly="ro.shangpinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商城图书名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng"
                placeholder="商城图书名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="商城图书分类" prop="shangpinfenlei">
          <el-select :disabled="ro.shangpinfenlei" v-model="ruleForm.shangpinfenlei" placeholder="请选择商城图书分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="商城图书分类" prop="shangpinfenlei">
	      <el-input v-model="ruleForm.shangpinfenlei"
                placeholder="商城图书分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出版社" prop="pinpai">
          <el-input v-model="ruleForm.pinpai"
              placeholder="出版社" clearable  :readonly="ro.pinpai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出版社" prop="pinpai">
              <el-input v-model="ruleForm.pinpai"
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="图书作者" prop="chima">
          <el-select :disabled="ro.chima" v-model="ruleForm.chima" placeholder="请选择图书作者">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="图书作者" prop="chima">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="编写年份" prop="yanse">
          <el-input v-model="ruleForm.yanse"
              placeholder="编写年份" clearable  :readonly="ro.yanse"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="编写年份" prop="yanse">
              <el-input v-model="ruleForm.yanse"
                placeholder="编写年份" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="商城图书详情" prop="shangpinxiangqing">
                <editor
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinxiangqing" label="商城图书详情" prop="shangpinxiangqing">
...
export default {
  data() {
	...
	alllimittimes : false,
      ...
      rules: {
          shangpinmingcheng: [
                { required: true, message: '商城图书名称不能为空', trigger: 'blur' },
          ],
          shangpinfenlei: [
                { required: true, message: '商城图书分类不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          pinpai: [
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/shangpinchima/chima`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../book-shop/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
