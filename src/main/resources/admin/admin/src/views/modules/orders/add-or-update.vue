<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">
        <el-form-item class="upload" v-if="type!='info' && !ro.picture" label="商城图书图片" prop="picture">
          <file-upload
          tip="点击上传商城图书图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.picture" label="商城图书图片" prop="picture">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../book-shop/upload');
        } else {
