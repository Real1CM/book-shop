<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="图书作者" prop="chima">
          <el-input v-model="ruleForm.chima"
              placeholder="图书作者" clearable  :readonly="ro.chima"></el-input>
        </el-form-item>
        <div v-else>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					 ...
					 this.$http({
					   url: `shangpinchima/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shangpinchimaCrossAddOrUpdateFlag = false;
						 this.parent.search();
