<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商城图书表名" prop="tablename">
          <el-input v-model="ruleForm.tablename"
              placeholder="商城图书表名" clearable  :readonly="ro.tablename"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商城图书表名" prop="tablename">
              <el-input v-model="ruleForm.tablename"
                placeholder="商城图书表名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商城图书id" prop="goodid">
          <el-input v-model="ruleForm.goodid"
              placeholder="商城图书id" clearable  :readonly="ro.goodid"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商城图书id" prop="goodid">
              <el-input v-model="ruleForm.goodid"
                placeholder="商城图书id" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商城图书名称" prop="goodname">
          <el-input v-model="ruleForm.goodname"
              placeholder="商城图书名称" clearable  :readonly="ro.goodname"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商城图书名称" prop="goodname">
              <el-input v-model="ruleForm.goodname"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商城图书类型" prop="goodtype">
          <el-input v-model="ruleForm.goodtype"
              placeholder="商城图书类型" clearable  :readonly="ro.goodtype"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="商城图书类型" prop="goodtype">
              <el-input v-model="ruleForm.goodtype"
                placeholder="商城图书类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
	...
	goodtype : false,
      ...
      rules: {
          ...
          goodid: [
                { required: true, message: '商城图书id不能为空', trigger: 'blur' },
          ],
          goodname: [
          ],
          picture: [
